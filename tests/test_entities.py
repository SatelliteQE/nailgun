...
class PathTestCase(TestCase):
    ...
    def test_id_and_which(self):
        ...
        for entity, which in (
            ...
            (entities.RHCloud, 'download_report'),
            (entities.RHCloud, 'generate_report'),
            (entities.RHCloud, 'inventory_sync'),
...
class GenericTestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.methods_requests = (
            ...
            (entities.RHCloud(**generic).download_report, 'get'),
            (entities.RHCloud(**generic).generate_report, 'post'),
            (entities.RHCloud(**generic).inventory_sync, 'post'),
