...
class PathTestCase(TestCase):
    ...
    def test_nowhich(self):
        ...
        for entity, path in (
                ...
                (entities.ProductsBulkActions, '/products/bulk'),
    ...
    def test_noid_and_which(self):
        ...
        for entity, which in (
                ...
                (entities.ProductsBulkActions, 'destroy'),
                (entities.ProductsBulkActions, 'sync'),
                (entities.ProductsBulkActions, 'http_proxy'),
                (entities.ProductsBulkActions, 'sync_plan'),
...
class GenericTestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.methods_requests = (
            ...
            (entities.ProductsBulkActions(**generic).destroy, 'put'),
            (entities.ProductsBulkActions(**generic).sync, 'put'),
            (entities.ProductsBulkActions(**generic).http_proxy, 'put'),
            (entities.ProductsBulkActions(**generic).sync_plan, 'put'),
